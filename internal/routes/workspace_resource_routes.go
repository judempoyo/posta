...
func (r *Router) workspaceResourceRoutes() []okapi.RouteDefinition {
	...
	routes = append(routes, []okapi.RouteDefinition{
		...
		},
		{
			...
			Group:    opsGroup,
			Tags:     []string{tagTemplateVersions},
		...
		},
		{
			...
			Group:    opsGroup,
			Tags:     []string{tagTemplateLocalizations},
		...
		},
		{
			...
			Group:   opsGroup,
			Tags:    []string{tagUnsubscribeLists},
		...
		},
		{
			...
			Group:   opsGroup,
			Tags:    []string{tagSubscriberLists},
		...
		{
			Method:   http.MethodPost,
			Path:     pathSubscriberListMembers,
